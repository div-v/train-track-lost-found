        ...
        Padding(
          ...
          child: TextField(
            decoration: InputDecoration(
              ...
              hintText: "Search lost items, train/station...",
              isDense: true,
          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snap) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (_, i) =>
                    ItemCard(item: docs[i], itemType: "lost"),
              );
            },
          ),
        ),
...
// Reuse ExpandableText and showPopupImageDialog from above or extract to a shared file.
// To keep this self-contained, duplicate minimal parts:
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            GestureDetector(
              onTap: (item['photoUrl'] ?? '').toString().isNotEmpty
              ...
              child: ClipRRect(
                ...
                child: (item['photoUrl'] ?? '').toString().isNotEmpty
                    ? Image.network(
                        item['photoUrl'],
